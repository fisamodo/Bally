...
APaddle::APaddle()
{
	...
	SM_Paddle->SetConstraintMode(EDOFMode::XZPlane); //Sets movement on X and Z coordinate, doesn't allow to go UP and DOWN
	SM_Paddle->SetCollisionEnabled(ECollisionEnabled::QueryAndPhysics);//Makes it a solid body
